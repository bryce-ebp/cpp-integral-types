...
int main() {
    ...
    std::cout << "var: " << var << '\n'
            ...
            << "var is_pow_2: " << var.is_pow_2() << "\n\n\n"


            << "test: " << test << '\n'
            << "test pow: " << test.pow(3) << '\n'
            << "test leading_zeros: " << test.leading_zeros() << '\n'
            << "test trailing_zeros: " << test.trailing_zeros() << '\n'
            << "test sizeof(bitset): " << sizeof(u32) << '\n'
            << "test bitset_to_string: " << test.bitset_str() << "\n\n\n"


            << "var2: " << var2 << '\n'
            << "var2: get_max: " << var2.get_max() << '\n'
            << "var2: get_min: " << var2.get_min() << '\n'
            << "var2: next_pow_2: " << var2.next_pow_2() << '\n'
            << "var2 is_pow2: " << var2.is_pow_2() << "\n\n\n"
